...
#define C_FG_LIGHT_GREY_BG_GREEN C_FG_LIGHT_GREY | C_BG_GREEN
#define C_FG_BLUE_BG_GREEN 		C_FG_BLUE | C_BG_GREEN
#define C_FG_RED_BG_GREEN 		C_FG_RED | C_BG_GREEN

#define C_FG_BLACK_BG_LIGHT_GREY C_FG_BLACK | C_BG_LIGHT_GREY
#define C_FG_WHITE_BG_LIGHT_GREY C_FG_WHITE | C_BG_LIGHT_GREY
